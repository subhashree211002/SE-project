          ...
          <div class="modal-body">
            <form @submit.prevent="CreateTicket">
              ...
              <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="priority" id="lowPriority" value="Low" v-model="priority">
                <label class="form-check-label" for="lowPriority">
                  Low Priority
                </label>
              </div>
              <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="priority" id="highPriority" value="High" v-model="priority">
...
<script>import { useVuelidate } from "@vuelidate/core";
      ...
      if (this.v$.$error) {
        ...
        fetch(`http://127.0.0.1:5500/api/subject/${this.subject_tag}`, {
          ...
          body: JSON.stringify({
            ...
            priority: this.priority, // Sending priority data to backend
          }),
        })
