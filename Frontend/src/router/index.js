...
import StudentProfileView from "../views/StudentProfileView.vue"; // Import the ProfileView component
...
const routes = [
  ...
  { path: "/StudentProfile", name: "Student Profile Page", component: StudentProfileView }, // Add route for the student profile page
  { path: "/AdminProfile", name: "Admin Profile Page", component: AdminProfileView }, // Add route for the admin profile page
];
