                ...
                <div class="card">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="checkbox" id="ticketNotifications" v-model="ticketNotifications">
                      <label for="ticketNotifications">Ticket Closure Notifications</label><br>
                      <input type="checkbox" id="discourseNotifications" v-model="discourseNotifications">
                      <label for="discourseNotifications">Discourse Replies Notifications</label>
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      ticketNotifications: false, // Initialize with user's ticket notifications preference
      discourseNotifications: false // Initialize with user's discourse notifications preference
    };
  },
  created() {
  ...
  methods: {
    ...
    updateProfile() {
      ...
      console.log("Updated profile details:", {
        ...
        ticketNotifications: this.ticketNotifications,
        discourseNotifications: this.discourseNotifications
      });
    }
  }
};
